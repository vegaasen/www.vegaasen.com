...
<html lang="en">
  ...
  <body data-spy="scroll" data-offset="0" data-target="#theMenu">
	...
	<nav class="menu" id="theMenu">
		<div class="menu-wrap">
			<h1 class="logo"><a href="index.php#introduction">Onassis</a></h1>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 desc desc-b">
					<h4>Project Data</h4>
					<p>
						<i class="icon-user"></i> Frank Lampard<br/>
						<i class="icon-tag"></i> Web Design<br/>
						<i class="icon-time"></i> 2013<br/>
						<i class="icon-globe"></i> www.blacktie.co<br/>
					</p>
				</div>
			</div>
		</div><!-- /container -->
		...
		<div class="container">
			...
			<br>
				<div class="col-lg-4 col-lg-offset-4">
					<a href="index.php#portfolio" style="font-size:20px;">< <i class="icon-th-large"></i> > </a>
				</div>
			</div>
		</div>
	</div><!-- /dg -->
