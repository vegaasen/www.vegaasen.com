...
(function () {
    ...
    jQuery(document).ready(function () {
        ...
        ['menu-introduction', 'menu-hobbies', 'menu-knowledge', 'menu-current-fiddles', 'menu-about', 'menu-contact'].forEach(function (element) {
            document.getElementById(element).onclick = function () {
                analyticsMenuItem(this.id);
            };
        });
        ['socialize-email', 'socialize-telephone', 'socialize-linkedin', 'socialize-facebook', 'socialize-twitter', 'socialize-instagram', 'socialize-github', 'socialize-steam', 'socialize-spotify'].forEach(function (element) {
            document.getElementById(element).onclick = function () {
                analyticsSocialize(this.id);
            };
        });
        ['menuToggle'].forEach(function (element) {
            document.getElementById(element).onclick = function () {
                analyticsMenuItem("main-actual-menu");
            };
        });
    });
})(jQuery);
